...
from model.freq_domain_fusion import FrequencyDomainFusion
...
class FTUNetFormer(nn.Module):
    ...
    def __init__(self,
        ...
        super().__init__()
        self.fusion = FrequencyDomainFusion(in_channels1=in_channels_rgb, in_channels2=in_channels_dsm, out_channels=in_channels_rgb)
        self.backbone = SwinTransformerV2(in_chans=in_channels_rgb, embed_dim=embed_dim, depths=depths, num_heads=num_heads, frozen_stages=freeze_stages)
